...
// Delay routines - exclude platforms with native sleep/usleep support
// ESP32 (Xtensa) uses FreeRTOS with its own sleep functions
#if !defined(__linux__) && !defined(__FreeBSD__) && !defined(__XTENSA__) && !defined(ESP_PLATFORM)
